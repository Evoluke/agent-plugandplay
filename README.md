...
- O vencimento consolidado fica armazenado em `company.subscription_expires_at`, permitindo que toda a aplicação valide a expiração corporativa sem depender de campos na tabela `agents`; o backend agora inicia essa coluna com 7 dias de acesso gratuito e, a partir daí, aguarda as atualizações vindas das integrações externas.
