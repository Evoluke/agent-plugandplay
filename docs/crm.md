...
- Sempre que precisar comunicar bloqueios por assinatura no CRM, deixe explícito que a validação ocorre no nível da empresa e consome `company.subscription_expires_at`, mantendo a mensagem coerente com o restante do painel.
