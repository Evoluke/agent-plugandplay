...
- As CTAs provenientes do gerador de currículo redirecionam para **/pricing** após a etapa de download; garanta que a página do CRM mantenha a mesma identidade visual (paleta, tipografia e espaçamento) para reforçar a continuidade da jornada.
