...
- A partir da atualização do board, os cabeçalhos também exibem o MRR agregado em um _chip_ compacto alinhado à cor primária (`bg-primary/10` com `text-primary`).
...
- As áreas de drop vazias devem manter fundo claro em degradê, ícone `Inbox` em cinza suave e mensagem em caixa alta convidando o usuário a arrastar cards; durante o _drag_, aplicar borda `border-primary/20` e fundo `bg-primary/5`.
