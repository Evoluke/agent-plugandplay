...
- As cores dos estágios são configuráveis no modal do funil; utilize tons contrastantes dentro da paleta sugerida para reforçar a identidade das colunas sem comprometer a legibilidade.
