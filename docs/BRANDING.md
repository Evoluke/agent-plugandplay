...
- As colunas herdam o fundo configurado no banco via `stage.color`; mantenha tonalidades claras (ex.: `#F8FAFC`) para preservar o contraste dos textos cinza-escuros.
