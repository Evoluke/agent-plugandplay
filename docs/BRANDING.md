...
- Qualquer tela que comunique a assinatura deve continuar considerando somente o vencimento consolidado em `company.subscription_expires_at`, ignorando cobranças futuras pendentes para evitar alarmes incorretos e destacando que a etiqueta de vigência só muda para expirada a partir de 00h00 do dia seguinte ao vencimento exibido; o backend já grava 7 dias de teste gratuito ao criar a empresa e, depois dessa fase, as automações externas (ex.: N8N) seguem como responsáveis por atualizar a vigência.
